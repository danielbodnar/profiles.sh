...
/** JSON columns stored as TEXT in the projects table */
const JSON_COLUMNS = ['tech', 'persona_map'] as const;
 ...
 *
 * Returns the array of project cards for a GitHub user.
 */
export const GET: APIRoute = async ({ params, locals }) => {
  try {
    ...
    // No projects — determine whether the profile exists at all
    ...
    // Profile exists but no projects yet — still computing
    return jsonResponse(
      {
        status: 'computing',
        username,
    ...
    console.error('GET /api/:username/projects error:', error);
